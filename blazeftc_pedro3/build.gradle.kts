...
android {
    namespace = "dev.anygeneric.blazeftc_pedro3"
    compileSdk {
        version = release(34)
    }
...
dependencies {
    ...
    compileOnly("com.pedropathing:core:3.0.0.local.alpha13")
    compileOnly("com.pedropathing:revhub:3.0.0.local.alpha13")
}
